...
function BalanceOverview({ balance, incomeTotal, expenseTotal }) {
  return (
    <div className="card card-padded mb-8">
      ...
      <p className="text-value-hero mt-2 text-[42px] leading-none sm:text-[52px]">
      ...
      <div className="mt-8 grid grid-cols-2 gap-6 border-t border-[var(--color-border-soft)] pt-6 sm:gap-12">
        <div>
